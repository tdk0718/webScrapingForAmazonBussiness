    ...
    try {
      ...
      while (itemsData.getDocs(999).length) {
        ...
        for (let i = 0; i <= itemsData.getDocs(999).length; i++) {
          if ((_a = itemsData.getDocs(999)[i]) == null ? void 0 : _a.asin) {
            await typeTextByCss(driver2, "#importInputAsin", ((_b = itemsData.getDocs(999)[i]) == null ? void 0 : _b.asin) + " ");
            console.log((_c = itemsData.getDocs(999)[i]) == null ? void 0 : _c.asin);
          }
        }
